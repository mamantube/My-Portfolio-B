      ...
      <Row>
        <Col className=" d-flex justify-content-center align-items-center mb-5">
          <div className="social-buttons">
            ...
            <a href="https://www.linkedin.com/in/muhammad-firman-hidayat/" target="blank_" className="social-button linkedin">
              <svg
                viewBox="0 -2 44 44"
                version="1.1"
                xmlns="http://www.w3.org/2000/svg"
            ...
            <a href="https://web.facebook.com/m.hidayat.18" target="blank_" className="social-button facebook">
              <svg
                version="1.1"
                id="Layer_1"
                xmlns="http://www.w3.org/2000/svg"
            ...
            <a href="https://www.instagram.com/firman_dy07/" target="blank_" className="social-button instagram">
              <svg
                width="800px"
                height="800px"
                viewBox="0 0 20 20"
