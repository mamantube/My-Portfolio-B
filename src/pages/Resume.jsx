      ...
      <div className="my-certificate mt-5">
        ...
        <Row className=" mt-5">
          ...
          <Col className="description">
            ...
            <p>
              <MdOutlineDoubleArrow /> Learn layouting techniques using Flexbox
              in building web page content
            </p>
          </Col>
        </Row>
        <Row className=" mt-5">
        ...
        <Row className=" mt-5">
          ...
          <Col style={{ marginTop: "23px" }}>
            ...
            <p style={{ lineHeight: "16px" }}>
              <MdOutlineDoubleArrow /> Explain the concept of OOP in JavaScript
            </p>
            <p style={{ lineHeight: "16px" }}>
